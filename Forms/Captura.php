        ...
        <div class="panel panel-body">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <select class="form-control" placeholder="Ocupación" id="ddlOcupacion">
            ...
            <div class="col-md-4">
              ...
              <select class="form-control" placeholder="Escolaridad" id="ddlEscolaridad">
            ...
            <div class="col-md-4">
              ...
              <select id="ddlEstandar" class="form-control select2" placeholder="Estandar Buscado">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <select id="ddlEstadoEstandar" class="form-control select2" placeholder="Estado donde se localiza">
                <option selected value="-1" disabled>Seleccione estado donde se localiza</option>
              </select>             
            </div>
            <div class="col-md-4">
              <label>Prestador del servicio</label>
              <select id="ddlPrestadorEstadoEstandar" class="form-control select2" placeholder="Estado donde se localiza">
            ...
            <div class="col-md-4">
              ...
              <div class="input-group input-group-sm ">
                <div class="select2-container">
                  <select id="ddlRepresentante" class="form-control select2" placeholder="Prestador de Servicio">
          ...
          <div class="row">
            <div class="col-md-12">
              <button id="btnCapturar" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Capturar</button>
            </div>
          </div>        
        </div>
      </div>