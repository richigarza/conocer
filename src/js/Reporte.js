        ...
        GLOBAL.app.sendJson("BLL/index.php?fn=reporte", datos, function(response){
            if(response.success){
				...
				response.output.forEach(function(row) {
					strd = "<tr><td>"+row["idSolicitante"]+"</td>
								<td>"+row["solicitanteType"]+"</td>
								<td>"+row["nombre"]+"</td>
								<td>"+row["apellidoPaterno"]+"</td>
								<td>"+row["apellidoMaterno"]+"</td>
								<td>"+row["bitMigrante"]+"</td>
								<td>"+row["migrante"]+"</td>
								<td>"+row["bitCertificado"]+"</td>
								<td>"+row["certificado"]+"</td>
								<td>"+row["bitEstandarizado"]+"</td>
								<td>"+row["estandarizado"]+"</td>
								<td>"+row["email"]+"</td>
								<td>"+row["telefono"]+"</td>
								<td>"+row["nombreEmpresa"]+"</td>
								<td>"+row["idTipoEmpresa"]+"</td>
								<td>"+row["tipoEmpresa"]+"</td>
								<td>"+row["idEstado"]+"</td>
								<td>"+row["estadoSolicitante"]+"</td>
								<td>"+row["idMedioContacto"]+"</td>
								<td>"+row["medioContacto"]+"</td>
								<td>"+row["fechaNacimiento"]+"</td>
								<td>"+row["idOcupacion"]+"</td>
								<td>"+row["ocupacion"]+"</td>
								<td>"+row["idEscolaridad"]+"</td>
								...
								<td>"+row["fechaAlta"]+"</td>
								<td>"+row["idVisita"]+"</td>
								<td>"+row["idTipoLlamada"]+"</td>
								<td>"+row["tipoLlamada"]+"</td>
								<td>"+row["idCursosCapacitacion"]+"</td>
								<td>"+row["cursosCapacitacion"]+"</td>
								<td>"+row["idMotivo"]+"</td>
								<td>"+row["motivo"]+"</td>
								<td>"+row["idEstandar"]+"</td>
								<td>"+row["estandar"]+"</td>
								<td>"+row["idEstadoVisita"]+"</td>
								<td>"+row["estadoVisita"]+"</td>
								<td>"+row["idPrestador"]+"</td>
								<td>"+row["cedulaP"]+"</td>
								<td>"+row["nombrePrestador"]+"</td>
								<td>"+row["idRepresentante"]+"</td>
								<td>"+row["cedulaR"]+"</td>
								<td>"+row["nombrePrestador"]+"</td>
								<td>"+row["idMedioEntero"]+"</td>
								<td>"+row["medioEntero"]+"</td>
								<td>"+row["idSecretaria"]+"</td>
								<td>"+row["secretaria"]+"</td>
								<td>"+row["asunto"]+"</td>
								<td>"+row["idDirigidoA"]+"</td>
								<td>"+row["dirigidoA"]+"</td>
